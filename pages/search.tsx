...
import useSearch, { useSearchTaiko } from '../hooks/useSearch';
...
const SearchTaiko: React.FC<{}> = () => {
  const router = useRouter();
  const searchQuery = router.query.q;
  const { loaded, results } = useSearchTaiko(searchQuery as string);
...
export default EXPLORER_NETWORK === 'TAIKO' ? SearchTaiko : Search;
